        ...
        <ul className="list-group list-group-light" id="chatList">
            ...
            <li className="list-group-item d-flex justify-content-between align-items-center">
                <div className="d-flex align-items-center">
                        <img alt="" style={{width: '45px', height: '45px'}} className="rounded" src='https://mdbootstrap.com/img/new/avatars/8.jpg'></img>
                        <div className="ms-3">
            ...
            <li className="list-group-item d-flex justify-content-between align-items-center">
                <div className="d-flex align-items-center">
                        ...
                        <img  style={{width: '45px', height: '45px'}} className="rounded" src='https://mdbootstrap.com/img/new/avatars/6.jpg'></img>
                        <div className="ms-3">
            ...
            <li className="list-group-item d-flex justify-content-between align-items-center">
                ...
                <div className="d-flex align-items-center">
                        <img alt="" style={{width: '45px', height: '45px'}} className="rounded" src='https://mdbootstrap.com/img/new/avatars/7.jpg'></img>
                            <div className="ms-3">
